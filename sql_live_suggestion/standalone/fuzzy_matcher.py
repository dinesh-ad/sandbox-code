...
This module provides high-performance fuzzy string matching
...
class FuzzyMatch:
    ...
    name: str       # The matched candidate
...
class FuzzyMatcher:
    ...
    Example:
        ...
        matches = matcher.find_matches("studnt", ["student", "course", "employee"])
        # Returns: [FuzzyMatch(name="student", score=92)]
    """
    
    def __init__(self, threshold: int = 50, max_results: int = 5):
        """
